...
export class VitalSignsSummaryController {
  constructor(private readonly vitalSignsSummaryService: VitalSignsSummaryService) {}
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateVitalSignsSummaryDto: UpdateVitalSignsSummaryDto) {
    return this.vitalSignsSummaryService.update(+id, updateVitalSignsSummaryDto);
  }
